...
@WebServlet(urlPatterns = { "/categories/add", "/categories/update", "/categories/delete" })
...
public class CategoryEditController extends HttpServlet {
	...
	private void doGetUpdate(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			RequestDispatcher dispatcher = req.getRequestDispatcher("/views/categories-update.jsp");
			dispatcher.forward(req, resp);
		} catch (ServletException e) {
			req.setAttribute("error", e.getMessage());
			RequestDispatcher dispatcher = req.getRequestDispatcher("/views/categories-update.jsp");
